...
alias activate_venv="source /home/vedant/Project/yolox_env/bin/activate.fish"
alias rfish="source /home/vedant/.config/fish/config.fish"
alias cfish="nvim /home/vedant/.config/fish/config.fish"
alias ckitty="nvim /home/vedant/.config/kitty/kitty.conf"
alias rkitty="source /home/vedant/.config/kitty/kitty.conf"
...
function fish_user_key_bindings
    bind \t accept-autosuggestion # Tab to accept and execute full suggestion
    bind \eq forward-word # Alt + Q to accept next word of suggestion
    # Existing bindings for !! and !$
    if [ "$fish_key_bindings" = fish_vi_key_bindings ]
...
# Enable fzf for enhanced completions
if type -q fzf
    fzf --fish | source
end
...
alias practice="cd ~/Python/Practice"
alias rfish="source ~/.config/fish/config.fish"
alias wallpapers="cd ~/Pictures/Wallpapers"
alias Project="cd ~/Project"
alias rmo="sudo pacman -Rs $(pacman -Qdtq)"
alias fhistory="nvim ~/.local/share/fish/fish_history"
