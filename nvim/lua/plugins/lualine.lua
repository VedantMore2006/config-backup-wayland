    ...
    opts = function()
      ...
      local function get_active_lsp_name()
        ...
        for _, client in ipairs(clients) do -- Iterates through the list of LSP clients
          if client.name ~= "copilot" and client.name ~= "ruff" then -- Checks if the client is not Copilot or ruff
            return client.name -- Returns the name of the first non-Copilot/ruff LSP client
          end
        end
        ...
        sections = {
          ...
          -- stylua: ignore
          {
            ...
            },
            {
              ...
              icon = "󰒋", -- Icon for the LSP component (gear symbol)
              color = { fg = colors.teal }, -- Applies the custom teal color to the component
            },
          },
          lualine_y = {
